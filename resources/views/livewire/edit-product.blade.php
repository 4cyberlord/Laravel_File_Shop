<form wire:submit.prevent="submit" class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-4 md:p-8 space-y-12">
    <section class="space-y-6">
        ...
        <div>
            ...
            <x-textarea wire:model.lazy="state.description" id="description" class="block mt-1 w-full" rows="4"
        ...
        <ul>
            ...
            <li>
                ...
                <button type="button" class="text-indigo-500"
                    wire:click="removeExistingFile('{{ $file->id }}')">Remove</button>
            </li>
            @endforeach
            ...
            <li>
                ...
                <button type="button" class="text-indigo-500"
                    wire:click="removeFile('{{ $file->getFilename() }}')">Remove</button>
            </li>
            @endforeach
        </ul>
